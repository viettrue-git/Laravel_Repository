    ...
    <div class="col-lg-12">
        @include('Layout_admin.alert')
            ...
            <div class="panel-body">
                <div class="form">
                    <form class="cmxform form-horizontal " id="commentForm" method="POST" action="{{route('brand.update',$brand->id)}}" enctype="multipart/form-data">
                       @csrf @method('PUT')
                        <div class="col-lg-9">
                            <div class="form-group ">
                                <label for="cname" class="control-label col-lg-3">Tên loại</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" id="cname" name="name" minlength="2" type="text" required="" value="{{$brand->name}}">                     
                                    @error('name')
                       ...
                       <div class="col-lg-3">
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control " id="cemail" value="{{$brand->logo}}" type="file" name="file_image">
                            </div>
                        </div>
                        <div class="form-group">
